...
namespace SmartUniversity.Areas.Customer.Controllers
{
    ...
    public class DoctorsAndAssistantController : Controller
    {
        ...
        public async Task<IActionResult> DoctorCourse()
        {
            ...
            var courses = await _unitOfWork.UniversityCourses.GetAsync(e => e.DoctorID == doctor.Id,
        ...
        public async Task<IActionResult> AssistantCourse()
        {
            ...
            var courses = await _unitOfWork.AssistantCourses.GetAsync(e => e.AssistantId == assistant.Id,
        ...
        public async Task<IActionResult> AddMaterial(MaterialVM materialVM)
        {
            ...
            TempData["success-notification"] = "Add Material successfully!";
        ...
        public async Task<IActionResult> EditMaterial(MaterialVM materialVM)
        {
            ...
            TempData["success-notification"] = "Edit Material successfully!";
        ...
        public async Task<IActionResult> DeleteMaterial(int id)
        {
            ...
            TempData["success-notification"] = "Delete Material successfully!";
